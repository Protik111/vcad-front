 ...
 */
export default function CourseStructureSection({ curriculum }: { curriculum: CurriculumYear[] }) {
    ...
    <section id="structure" className="scroll-mt-24 py-20 sm:py-28">
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">Course Structure &amp; Details</h2>
        ...
        <div className="mt-10 rounded-card border border-border/60 bg-card p-6 sm:p-10">
          ...
          <div role="tabpanel" aria-labelledby={tablistId} className="mt-8">
            <p className="text-default font-semibold uppercase tracking-[0.08em] text-pink">
              Modules may include
            </p>
            <h3 className="mt-2 text-2xl font-semibold text-white">Core Modules</h3>
